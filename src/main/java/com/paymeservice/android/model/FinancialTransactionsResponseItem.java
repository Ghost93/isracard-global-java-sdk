...
public class FinancialTransactionsResponseItem {
    public static FinancialTransactionsResponseItem fromJson(Moshi moshi, String json) throws IOException {
        JsonAdapter<FinancialTransactionsResponseItem> adapter = moshi.adapter(FinancialTransactionsResponseItem.class);

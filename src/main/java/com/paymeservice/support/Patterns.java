package com.paymeservice.support;
...
public class Patterns {
  ...
  /**
   * Regular expression to match all IANA top-level domains. List accurate as of 2010/02/05.  List
   ...
   * 2010/02/05.  List taken from: http://data.iana.org/TLD/tlds-alpha-by-domain.txt This pattern is
